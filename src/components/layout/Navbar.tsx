    ...
    >
      <Container className="flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2">
          ...
          <span className="font-heading font-bold text-xl tracking-tight">DeepWork</span>
        </Link>
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <Link href="#features" className="text-sm font-medium text-muted hover:text-white transition-colors">
            Features
          </Link>
          <Link href="#testimonials" className="text-sm font-medium text-muted hover:text-white transition-colors">
            Testimonials
          </Link>
